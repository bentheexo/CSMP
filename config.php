...
//Mail
$CONFIG['smtp_server']		=	'smtp.gmail.com';	// the smtp server, the cp will use to send mails
$CONFIG['smtp_port']		=	'465';			// the smtp server port
$CONFIG['smtp_mail']		=	'bhenderson904@gmail.com';		// the email of the admin
$CONFIG['smtp_username']	=	'bhenderson904@gmail.com';			// the username of the smtp server
$CONFIG['smtp_password']	=	'iiyama22"insignia';			// the password of the smtp server
