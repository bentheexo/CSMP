...
function main_menu() {
	...
	for (i = 0; i < mainmenu.length; i++)
		the_menu = the_menu + "<li><span onClick=\"return sub_menu(" + i + ");\">" + mainmenu[i] + "</span></li>";
...
function sub_menu(index) {
	...
	for (i = 0; i < submenu.length; i = i + 3) {
		...
		the_menu = the_menu + "<li><span onClick=\"return LINK_ajax('" + submenu[i + 1] + "','main_div');\">" + submenu[i] + "</span></>";
	}
